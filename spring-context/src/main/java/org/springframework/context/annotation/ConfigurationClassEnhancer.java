...
class ConfigurationClassEnhancer {
	...
	private Enhancer newEnhancer(Class<?> configSuperClass, @Nullable ClassLoader classLoader) {
		...
		//主要为cglib类中添加成员变量$$beanFactory
		//同时基于EnhancedConfiguration的父类接口BeanFactoryAware的setBeanFactory方法完成注入
		//设置$$beanFactory为上下文中的工厂
		//这样一来，第二次调用方式时就不会再创建个对象了，而是直接从工厂中获取了
